    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this, READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
            if(ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this, READ_CONTACTS)) {
                ...
                ActivityCompat.requestPermissions(MainActivity.this, new String[]{READ_CONTACTS},99 );
            }}
        else{}


        if (ActivityCompat.checkSelfPermission(this, WRITE_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
            if(ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this, WRITE_CONTACTS)) {
            }else {
                ActivityCompat.requestPermissions(MainActivity.this, new String[]{WRITE_CONTACTS},99 );
            }}
        else{}
